...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False):
        ...
        if pt:  # PyTorch
            ...
            check_requirements(('onnx', 'onnxruntime-gpu' if cuda else 'onnxruntime-directml'))
            import onnxruntime
            providers = ['CUDAExecutionProvider', 'CPUExecutionProvider'] if cuda else ['DmlExecutionProvider']
